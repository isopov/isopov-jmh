...
public class DeepCopyBenchmark {
	...
	{
		for (int i = 0; i < 10; i++) {
			state.add(new Copyable(i, (long) i, "Some String " + i));
		}
	}
...
//	c.s.m.j.DeepCopyBenchmark.loopCopy      avgt        15      193.952        2.393    ns/op
	...
	private static <T> T deepCopy(T obj) {
		try {
			//tried different values of the initial byte buffer size - no difference observed
	...
	public static class Copyable implements Serializable, Cloneable {
		...
		public boolean equals(Object o) {
			...
			if (field1 != copyable.field1) return false;
			if (field2 != copyable.field2) return false;
			if (field3 != null ? !field3.equals(copyable.field3) : copyable.field3 != null) return false;
